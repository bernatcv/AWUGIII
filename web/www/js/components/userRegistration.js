const userLoginTemplate = {props: [], 
  ...
  <div style="margin-top: 5%">
        ...
        <h2>Registro de un nuevo usuario</h2>
			...
			<md-button class="md-raised md-primary" style="width:80%;" onclick="location.href='userLogin.html';">Crear cuenta</md-button><br>
       ...
       <div class="botton">
       		<a href="userLogin.html" style="margin: 10px auto;">
